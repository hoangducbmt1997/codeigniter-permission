<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="<?php echo base_url('dashboard') ?>" class="brand-link text-center">
			<span class="brand-text font-weight-bold">Dashboard GCE-WD</span>
		</a>
		...
		<div class="sidebar">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<?php
				if (!empty($this->session->userdata('user_logged')['image'])):
					?>
					<div class="image">
						<img src="<?php echo base_url('/uploads/admin/users/' . $this->session->userdata('user_logged')['image']); ?>" class="img-circle elevation-2" alt="User Image">
					</div>
				<?php else: ?>
						<div class="image">
						<img src="<?php echo base_url('/uploads/admin/users/user-default.png') ?>" class="img-circle elevation-2" alt="User Image">
					</div>
				<?php endif; ?>
			...
			<nav class="mt-2">
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item">
						<a href="<?php echo base_url('language/list') ?>" class="nav-link">
